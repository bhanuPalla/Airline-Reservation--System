<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewbooking.aspx.cs" Inherits="viewbooking" Title="Untitled Page" %>
    ...
    <table id="table1" border="0" cellpadding="1" cellspacing="1" width="600">
        <tr>
            <td align="left" bgcolor="#1f2b53" colspan="5" height="25" style="border-top-width: 1px;
                ...
                &nbsp;<span style="color: white"><strong>View your booking&nbsp; </strong></span></td>
        </tr>
        <tr>
