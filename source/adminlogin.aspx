<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="adminlogin.aspx.cs" Inherits="login" Title="Untitled Page" StylesheetTheme="AdminSkinFile" Theme="SkinFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="Table2" border="0" cellpadding="1" cellspacing="1" width="600">
        <tr>
            <td align="left" bgcolor="#660000" colspan="5" style="border-top-width: 1px; border-left-width: 1px;
                border-bottom: 1px solid; height: 25px; border-right-width: 1px" valign="middle">
                &nbsp;<span style="color: white"><strong>ADMIN Login to ARS</strong></span></td>
        </tr>
        <tr>
