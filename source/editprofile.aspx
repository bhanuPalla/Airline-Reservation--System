<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="editprofile.aspx.cs" Inherits="editprofile" Title="Untitled Page" StylesheetTheme="SkinFile" %>
    ...
    <table id="Table2" border="0" cellpadding="1" cellspacing="1" width="600">
        <tr>
            <td align="left" bgcolor="#1f2b53" colspan="5" style="border-top-width: 1px; border-left-width: 1px;
                ...
                &nbsp;<span style="color: white"><strong>ARS Edit Your Profile</strong></span></td>
        </tr>
        <tr>
